...
import { $ as $$BaseLayout } from './contact.astro.4a8c9382.mjs';
...
const $$Index$1 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index$1;
  const allPosts = await Astro2.glob(/* #__PURE__ */ Object.assign({"../posts/post-1.md": () => import('./post-1.md.279e74a1.mjs').then(n => n.p),"../posts/post-2.md": () => import('./post-2.md.b428904e.mjs'),"../posts/post-3.md": () => import('./post-3.md.37bddd62.mjs'),"../posts/this-is-a-test-blog.md": () => import('./this-is-a-test-blog.md.6c6b22b6.mjs'),"../posts/this-is-the-7th-blog.md": () => import('./this-is-the-7th-blog.md.c274dd13.mjs')}), () => "../posts/*.md");
