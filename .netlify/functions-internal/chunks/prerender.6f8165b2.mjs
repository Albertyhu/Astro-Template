/* empty css                          */import { c as createAstro, a as createComponent, r as renderTemplate, b as renderComponent, m as maybeRenderHead, d as addAttribute, _ as __astro_tag_component__ } from '../renderers.mjs';
  ...
  return renderTemplate`${maybeRenderHead()}<div class="rounded-lg box_shadow m-5 bg-white blog-preview-panel" id="blog-preview-panel">
    ...
    ${images && images.length > 0 && renderTemplate`<div class="object-fit cursor-pointer">
            <a${addAttribute(url, "href")}>
                <img${addAttribute(thumbnail.default.src, "src")}${addAttribute(images[0].alt, "alt")} class="w-full h-full">
            </a>
        </div>`}
    <p>
